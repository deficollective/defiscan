...
export function PizzaRosetteIcon({ values, className, isUnderReview, background = true }: Props) {
  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#outer-clip)">
        {background && (
          <circle cx="90" cy="90" r="90" className="fill-gray-100 dark:fill-neutral-700" />
        )}
        <g clipPath="url(#inner-clip)">
          <path
            ...
            onClick={() => scrollToSection(first.name)}
          />
          ...
          <path
            ...
            onClick={() => scrollToSection(second.name)}
          />
          ...
          <path
            ...
            onClick={() => scrollToSection(third.name)}
          />
          ...
          <path
            ...
            onClick={() => scrollToSection(fourth.name)}
          />
          ...
          <path
            ...
            onClick={() => scrollToSection(fifth.name)}
          />
